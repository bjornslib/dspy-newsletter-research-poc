...
```bash
python .claude/skills/mcp-to-skill-converter/mcp_to_skill.py --name <server-name>
```
...
```bash
python .claude/skills/mcp-to-skill-converter/mcp_to_skill.py --name github --output-dir /custom/path
```

### Specify Custom .mcp.json

```bash
python .claude/skills/mcp-to-skill-converter/mcp_to_skill.py --mcp-json /path/to/.mcp.json --name github --output-dir ./skills
```
